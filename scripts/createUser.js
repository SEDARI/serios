...
try {
  ...
  if (args.hasOwnProperty("help"))
    ...
    if(args.config){
        ...
        conf = require('../settings.js');
    }
      //hack to execute relative to the upper directory
      console.log("conf: ", conf.idm.core);
    if(conf.idm.core.storage.dbName.indexOf("/")!=0){
      conf.idm.core.storage.dbName = "../"+conf.idm.core.storage.dbName;
    }

    if(conf.idm.core.policies.dbName.indexOf("/")!=0){
      conf.idm.core.policies.dbName = "../"+conf.idm.core.policies.dbName;
    }
    ...
    if (args.username && args.auth) {
      ...
      var idmcore = new IdmCore(conf.idm.core);
